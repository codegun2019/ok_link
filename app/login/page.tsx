    ...
    <div className="min-h-screen bg-gradient-to-br from-[#E0F7FA] via-white to-cyan-50 flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md relative z-10 animate-fadeInUp">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2">ยินดีต้อนรับกลับ</h1>
          <p className="text-gray-600">เข้าสู่ระบบเพื่อจัดการลิงก์ของคุณ</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-6 md:p-8 backdrop-blur-sm bg-opacity-95">
          ...
          <div className="space-y-3 mb-6">
            ...
            >
              ...
              <span className="text-gray-700 font-medium">เข้าสู่ระบบด้วย Facebook</span>
            </Button>
            ...
            >
              ...
              <span className="text-gray-700 font-medium">เข้าสู่ระบบด้วย LINE</span>
            </Button>
          </div>
